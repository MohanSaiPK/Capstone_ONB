...
public class ONBStateModel {
    ...
    private boolean agGridEnable = true;

    public boolean isAgGridEnable() {
        return agGridEnable;
    }

    public void setAgGridEnable(boolean agGridEnable) {
        this.agGridEnable = agGridEnable;
    }
    ...
    public void enableOpen() {
        // Enable fields for open/initial screen (not always disabled fields)
        inspectionCodeDisabled = false;
        dateOfInspectionDisabled = false;
        lastInspectionDateDisabled = false;
        placeOfInspectionDisabled = false;
        fromPortCodeDisabled = true;
        fromPortNameDisabled = true; // Name disabled, code disabled
        toPortCodeDisabled = true;
        toPortNameDisabled = true; // Name disabled, code disabled
        inspectorNameDisabled = false;
        commentsDisabled = false;
        value1Disabled = false;
        twoColFromDisabled = false;
    ...
    public void enableEdit() {
        // Enable all fields except from/to port codes/names
        inspectionCodeDisabled = false;
        dateOfInspectionDisabled = false;
        lastInspectionDateDisabled = false;
        ...
        addToInspectionDisabled = true; // disable add button in edit mode
    }
